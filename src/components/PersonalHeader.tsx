    ...
    <div className="bg-gradient-to-r from-purple-600 via-indigo-600 to-blue-600 p-6 text-white relative overflow-hidden">
      ...
      <div className="flex items-center gap-5 relative z-10">
        <img
          ...
          alt="余晖"
          className="w-28 h-28 rounded-xl object-cover shadow-2xl border-3 border-white/30 transition-transform duration-300 hover:scale-105"
        />
        <div>
          <h1
          ...
          <p className="text-lg text-purple-100 mb-2 font-title">前端架构师 | 技术团队Leader</p>
          <div className="bg-white/10 backdrop-blur-sm rounded-lg p-3 mb-3 border border-white/20">
            ...
            <p className="text-purple-100 text-sm leading-relaxed mt-0.5">
              🚀 擅长性能优化，曾将应用启动速度提升{' '}
          ...
          <div className="flex gap-4 text-sm">
            <div className="flex items-center gap-2 group">
              <i className="i-mdi-phone text-lg text-purple-200 group-hover:text-white transition-colors"></i>
              <span className="group-hover:text-white transition-colors">15766495385</span>
            </div>
            <div className="flex items-center gap-2 group">
              <i className="i-mdi-email text-lg text-purple-200 group-hover:text-white transition-colors"></i>
              <a
