    ...
    <div className="space-y-4">
      <div className="project-card bg-gradient-to-br from-gray-50 to-purple-50 rounded-xl p-4 shadow-sm hover:shadow-md transition-all duration-300">
        ...
        <div className="space-y-2">
          <div>
            <h5 className="text-sm font-semibold text-purple-600 mb-1">🚀 项目规模与挑战</h5>
            <p className="text-xs text-gray-700 leading-relaxed">
              <span className="font-medium text-purple-600">技术挑战：</span>从0到1构建
              <span className="bg-yellow-100 px-1 py-0.5 rounded">16款小游戏</span>
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="bg-gradient-to-r from-green-50 to-blue-50 p-2 rounded-lg">
                <p className="text-sm font-medium text-gray-800 mb-1">⚡ 性能优化策略</p>
                <ul className="list-disc list-inside space-y-0.5 text-gray-700 text-xs">
              ...
              <div className="bg-gradient-to-r from-purple-50 to-pink-50 p-2 rounded-lg">
                <p className="text-sm font-medium text-gray-800 mb-1">📊 数据驱动运营</p>
                <ul className="list-disc list-inside space-y-0.5 text-gray-700 text-xs">
          ...
          <div>
            <h5 className="text-sm font-semibold text-purple-600 mb-1">🏆 商业成果</h5>
            <div className="bg-gradient-to-r from-purple-50 to-blue-50 p-2 rounded-lg">
              <div className="grid grid-cols-3 gap-2 text-center">
                <div>
                  <div className="text-lg font-bold text-purple-600">4万+</div>
                  <div className="text-xs text-gray-600">日活跃用户</div>
                </div>
                <div>
                ...
                <div>
                  <div className="text-lg font-bold text-purple-600">5家</div>
                  <div className="text-xs text-gray-600">合作商户</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="project-card bg-gradient-to-br from-gray-50 to-purple-50 rounded-xl p-4 shadow-sm hover:shadow-md transition-all duration-300">
        ...
        <div className="space-y-2">
          <div>
            <h5 className="text-sm font-semibold text-purple-600 mb-1">🎯 产品规划</h5>
            <p className="text-xs text-gray-700 leading-relaxed">
          ...
          <div>
            <h5 className="text-sm font-semibold text-purple-600 mb-1">💡 核心功能</h5>
            <ul className="space-y-1 text-xs text-gray-700">
              <li className="leading-relaxed">
      ...
      <div className="project-card bg-gradient-to-br from-gray-50 to-purple-50 rounded-xl p-4 shadow-sm hover:shadow-md transition-all duration-300">
        ...
        <div className="space-y-2">
          <div>
            <h5 className="text-sm font-semibold text-purple-600 mb-1">🎯 系统设计</h5>
            <p className="text-xs text-gray-700 leading-relaxed">
          ...
          <div>
            <h5 className="text-sm font-semibold text-purple-600 mb-1">🔧 技术亮点</h5>
            <ul className="space-y-1 text-xs text-gray-700">
              <li className="leading-relaxed">
      ...
      <div className="project-card bg-gradient-to-br from-gray-50 to-purple-50 rounded-xl p-4 shadow-sm hover:shadow-md transition-all duration-300">
        ...
        <div className="space-y-2">
          <div>
            <h5 className="text-sm font-semibold text-purple-600 mb-1">🎯 产品定位</h5>
            <p className="text-xs text-gray-700 leading-relaxed">
          ...
          <div>
            <h5 className="text-sm font-semibold text-purple-600 mb-1">💡 移动端优化</h5>
            <ul className="space-y-1 text-xs text-gray-700">
              <li className="leading-relaxed">
          ...
          <div>
            <h5 className="text-sm font-semibold text-purple-600 mb-1">🔗 产品展示</h5>
            <div className="space-y-2">
              <a
